                        ...
                        {
                            {
                                ...
                                'user' : <div className='user'>
                                    <div className="userProfile">{props.listTitle[0]}{props.listTitle[1]}
                                    <div className={props.listTitle.available ?"card-profile-initial-available card-profile-initial-available-true" : "card-profile-initial-available"}></div>
                                    </div>
                                    {props.listTitle} 
                                    </div>
                            }[props.groupValue]
            ...
            <div className="list-card-items">
                {
                    props.ticketDetails.map(ticket => {
                        if(ticket.status === props.listTitle){
                            cardCount++;
                            return(<Card cardDetails={ticket} groupValue="status"/>)
                        }
                        else if(ticket.priority === props.listTitle){
                            cardCount++;
                            return(<Card cardDetails={ticket} groupValue="priority"/>)
                        }
                        else if(ticket.userObj.name === props.listTitle){
                            cardCount++;
                            return(<Card cardDetails={ticket} groupValue="user"/>)
                        }
                        return null
                    }, cardCount = 0)
