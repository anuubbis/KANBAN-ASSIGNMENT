        ...
        <div className="card-container">
            <div className="card-id-wrapper">
                ...
                <div className="card-profile">
                    ...
                    <div className={props.cardDetails.userObj.available ?"userProfile-initial-available userProfile-initial-available-true" : "card-profile-initial-available"}></div>
                </div>
            </div>
            <div className="card-title">
                {props.groupValue !== "status" && priorityList[props.cardDetails.status]}
